---
title: 'Building Context-Aware CI with GitHub Copilot SDK and Microsoft WorkIQ'
description: 'Overview   Building Context-Aware GitHub Actions with the Copilot SDK and Microsoft...'
...
featured: false
image:
  src: '/images/posts/building-context-aware-ci-with-github-copilot-sdk-and-microsoft-workiq/cover.png'
  alt: 'Cover image for Building Context-Aware CI with GitHub Copilot SDK and Microsoft WorkIQ'
sourceUrl: 'https://dev.to/vevarunsharma/building-context-aware-ci-with-github-copilot-sdk-and-microsoft-workiq-31bg'
---
...
**Show me the code**: [Full implementation on GitHub](https://github.com/VeVarunSharma/contoso-vibe-engineering/pull/27)
...
The [Copilot SDK](https://github.com/github/copilot-sdk) (`@github/copilot-sdk`) lets you build agentic workflows that leverage GitHub's AI infrastructure. Think of it as programmable Copilot—you define the prompt, the tools, and the outcome.
...
[WorkIQ](https://github.com/microsoft/work-iq-mcp) is Microsoft's natural language interface to your M365 data. It's currently in public preview and supports:
...
![cover-image](/images/posts/building-context-aware-ci-with-github-copilot-sdk-and-microsoft-workiq/cover.png)
